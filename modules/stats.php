<div class="panel-default panel">	
	<div class="panel-body">		
		<div class="stats-box-inner">
			<table>
				<td><img class="media-object" src="images/icons/statspage/totalplayers1.png" width="36" height="36" /></td>
					<td width="184"><strong>Total Players:</strong></td>
					<td align="right"><?php echo $num_totalplayers;?></td>
				</tr>
				<tr>
					<td><img class="media-object" src="images/icons/statspage/totalplayerin24h.png" width="36" height="36" /></td>
					<td><strong><font color="#428bca">Players in Last 24h:</strong></font></td>
					<td align="right"><?php echo $num_Played24h;?></td>
				</tr>
				<tr>
					<td><img class="media-object" src="images/icons/statspage/alivecharacters1.png" width="36" height="36" /></td>
					<td><strong><font color="#428bca">Alive Characters:</strong></font></td>
					<td align="right"><?php echo $totalAlive;?></td>
				</tr>
				<tr>
					<td><img class="media-object" src="images/icons/statspage/playerdeaths1.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Player Deaths:</strong></font></td>
							<td align="right"><?php echo $num_deaths;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/infectedkilled1.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Zombies Killed:</strong></font></td>
							<td align="right"><?php echo $KillsZ;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/infectedheadshots1.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Zombies Headshots:</strong></font></td>
							<td align="right"><?php echo $HeadshotsZ;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/murders.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Murders:</strong></font></td>
							<td align="right"><?php echo $KillsH;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/heroesalive1.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Heroes Alive:</strong></font></td>
							<td align="right"><?php echo $num_aliveheros;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/banditsalive1.png" width="36" height="36" /></td>
							<td><strong><font color="#428bca">Bandits Alive:</strong></font></td>
							<td align="right"><?php echo $num_alivebandits;?></td>
						</tr>
						<tr>
							<td><img class="media-object" src="images/icons/statspage/banditskilled1.png" width="36" height="36" /></td>
						...
						<tr>
							<td><img class="media-object" src="images/icons/statspage/vehicles.png" width="36" height="36" /></td>
